        ...
        <div className="relative flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 md:pl-6 lg:pl-10">
            <div className="mb-8 hidden md:block">
              ...
              <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                A room for every kind of maker
              </h1>
              <p className="md:text-md">
                We built this for artists who work outside the clean lines. The
                ones who make strange things, beautiful things, things that do
                not fit a spreadsheet.
              </p>
            </div>
            <div className="static flex flex-col flex-wrap justify-stretch md:block">
              <div className="relative grid auto-cols-fr grid-cols-1 grid-rows-[auto_auto] items-start md:mb-0 md:items-stretch">
                ...
                >
                  ...
                  >
                    <p className="mt-2">
                      You have the work. You need the wall. We give you the
                      wall.
                    </p>
                  </motion.div>
                </div>
