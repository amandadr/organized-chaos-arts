      ...
      <div className="container">
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            <p className="mb-3 font-semibold md:mb-4">Index</p>
            <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
              Find your next favorite artist
            </h2>
            <p className="md:text-md">
              A working directory of independent creators. Browse by medium or
              location.
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 gap-12 md:gap-16 lg:gap-20">
          <div>
            ...
            <div className="mt-5 grid grid-cols-1 items-start justify-between gap-6 md:mt-6 md:grid-cols-2 md:gap-20">
              ...
              <div>
                <p>
                  Hand-built vessels with volcanic glazes. Mara fires everything
          ...
          <div>
            ...
            <div className="mt-5 grid grid-cols-1 items-start justify-between gap-6 md:mt-6 md:grid-cols-2 md:gap-20">
              ...
              <div>
                <p>
                  Street photography from late-night walks. Theo shoots only on
                  expired film.
                </p>
              </div>
            </div>
