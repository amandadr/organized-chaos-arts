      ...
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Find us in the wild and at the gallery
          </h1>
          <p className="md:text-md">
            The best conversations happen in person. Come to a local market or
            follow along online.
          </p>
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4 md:mt-8">
            <Button title="Instagram" variant="secondary">
              Instagram
            </Button>
            <Button
              title="Events"
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  We post new art, studio visits, and event announcements on
                  Instagram. It is the fastest way to see what is happening.
                </p>
              </motion.div>
            </div>
            <div
