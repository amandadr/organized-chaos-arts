      ...
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            We design for inclusion from the start. Every event, every page,
            every listing should be usable by the widest range of people.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Venues are checked for step-free entry and clear signage. We
                  provide seating and quiet areas at every market.
                </p>
              </motion.div>
            </div>
            <div
