        ...
        <div>
          <div className="mb-6 md:mb-8">
            ...
            <p className="md:text-md">
              Send questions, feedback, or concerns. Moderators review every
              message within three business days.
            </p>
          </div>
          ...
          <div className="grid w-full items-center py-3 md:py-4">
            ...
            <RadioGroup className="grid grid-cols-2 gap-x-6 gap-y-3.5">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="#third_choice">Visitor</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fourth_choice" />
                <Label htmlFor="#fourth_choice">Partner</Label>
              </div>
              <div className="flex items-center space-x-2">
